...
export const floatValidateRange = (
  ...
  if (isRef(isOk)) {
    isOk.value = typeof val !== 'undefined' && isFloat(val.toString(), { min: minVal, max: maxVal })
    updateValid()
    return isOk.value
  } else {
    return true
...
export const floatValidateMin = (
  ...
  if (isRef(isOk)) {
    isOk.value = typeof val !== 'undefined' && isFloat(val.toString(), { min: minVal })
    updateValid()
    return isOk.value
  } else {
    return true
...
export const intValidateMin = (
  ...
  if (isRef(isOk)) {
    isOk.value = typeof val !== 'undefined' && isInt(val.toString(), { min: minVal })
    updateValid()
    return isOk.value
  } else {
    return true
...
export const intValidateMinMax = (
  ...
  if (isRef(isOk)) {
    isOk.value = typeof val !== 'undefined' && isInt(val.toString(), { min: minVal, max: maxVal })
    updateValid()
    return isOk.value
  } else {
    return true
